...
public class ScanLimited extends GhidraScript {

    static final String[] NEEDLES = {
        "Version limit", "Non disponible en version",
        "monstration", "Calculs en cours", "ARBITRAGE",
        "Simstra1"
    };
    ...
    public void run() throws Exception {
        ...
        outDir.mkdirs();
        PrintWriter w = new PrintWriter(new File(outDir, "limites_refs.txt"));
        ...
        PrintWriter c = new PrintWriter(new File(outDir, "limites_decompile.c"));
        int ok = 0;
        for (Function f : hits) {
